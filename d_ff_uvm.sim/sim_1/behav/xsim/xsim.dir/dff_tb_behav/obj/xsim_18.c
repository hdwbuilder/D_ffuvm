...
namespace XILINX_DPI { 
	...
	void dpiInitialize()
	{
		...
		DPIRelocateDPIScopeIP(0, (char*)(0x4077d8)) ;
...
extern "C" {
	...
	extern void subprog_m_4baa8978_556ead11_2241(char*, char*, char*);
}
...
extern "C" {
...

	{
		...
		SP = DPIInitializeFunction(IP + 423816, 168, 346048) ;
		char driver0[32] ;
		...
		DPIInvokeFunction(IP + callingProcessOffset, SP, (void*)(subprog_m_4baa8978_556ead11_2241), IP) ;
